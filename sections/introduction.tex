...
\end{codesnippet}
\end{adjustbox}
In Haskell these generic types were built in from the start are a key features of its type system. The analogy to the Java example is \emph{"test" : 1 : []} which does not compile.
...
It is known how many elements this list contains but this information is not available at compile time. 
