...
An introduction to Agda can be found in the following section \ref{section:first_steps_in_agda}. It includes all concepts and definitions which are required to understand the examples in section \ref{section:dependent_types}.
