...
A $\Sigma$-type is the generalization of the ordinary Cartesian product type $A \times B$. 
It is a combination of two types where each element of this type is a pair. 
But the type type of the second element may depend on the value of the first element.
...
As the implementation of $\Sigma$ in codesnippet \ref{codeSnippet:sigma} shows, it is possible to express $\Sigma$ in terms of $\Pi$ and no further language feature is required.
