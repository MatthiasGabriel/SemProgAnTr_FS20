...
are decreased by exactly one, the proof still holds, as suc n < suc m $\equiv$ tt and n $<$ m $\equiv$ tt are definitionally equal. \todo{explain definitially equal.}\todo{explain "proof"}\todo{research and explain how the first proof gets created.}
...
Because of the definition of \_$<$\_ of $\mathbb{N}$ on the last line is required too which proves that zero $<$ zero $\equiv$ tt is false as well. \todo{explain absurd pattern} \todo{maybe explain more why this different cases are required.}
